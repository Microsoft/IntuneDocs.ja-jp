...
詳細については、「[デバイスの種類の制限を設定する](enrollment-restrictions-set.md#create-a-device-type-restriction)」を参照してください。
...
詳細については、「[Intune でのデバイス コンプライアンスの概要](device-compliance-get-started.md)」を参照してください。
...
- [デバイスの種類の制限を設定する](enrollment-restrictions-set.md#create-a-device-type-restriction)

...
- NDES サービス アカウントの SPN を設定する =======
-   Windows サーバーに NDES を追加し、NDES をサポートするように IIS を構成する
>>>>>>> 3365d47d4 の親...ブランチ 'release-intune-1803' をマスターにマージする
...
1. Azure Portal で、**[デバイス構成]** ワークロードを選択します。
2. **[デバイス構成]** ウィンドウで、**[管理]** > **[プロファイル]** の順に選択します。
3. プロファイル ウィンドウで、**[プロファイルの作成]** を選択します。
4. **[プロファイルの作成]** ウィンドウで、SCEP 証明書プロファイルの **[名前]** と **[説明]** を入力します。
...
8. **[OK]** を選択して **[プロファイルの作成]** ウィンドウに戻り、**[作成]** を選択します。

...
description: Apple Configurator を使用して、セットアップ アシスタント (新しい UI) で会社所有の iOS デバイスを登録する方法について説明します。
keywords: ''
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>あるいは、**[デバイス登録]** ページが次の図のようになっている場合、アカウントは新しいユーザー インターフェイスにまだ更新されていません。 [こちらのヘルプ ページ](apple-configurator-enroll-ios.md)に移動してください。
>

...
2.  **[その他のサービス]** を選択し、フィルター ボックスに「**Intune**」と入力して、**[Intune]** を選択します。 Intune ブレードが開きます。 **[Mobile Apps]** を選択します。
...
6.  次に、**[新しいワイプ要求]** ブレードで **[デバイス]** を選びます。 このアクションで **[デバイスの選択]** ブレードが開きます。 これで、選択したユーザーに関連付けられているデバイスがすべて一覧表示されます。 また、このウィンドウではデバイス名 (ユーザーによって定義されたフレンドリ名)、およびデバイスの種類 (デバイス プラットフォームを示す) が提供されます。 

7. 一覧から、ワイプするデバイスを選択します。

8.  **[新しいワイプ要求]** ブレードに戻ります。 **[OK]** を選択してワイプ要求を行います。

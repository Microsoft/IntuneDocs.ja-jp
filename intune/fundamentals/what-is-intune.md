...
* [アプリの条件付きアクセス - モバイル アプリに企業データが含まれる場合、アクセスを許可する](../protect/app-based-conditional-access-intune.md)
* [同じアプリ内で企業データと個人データを分離する](../apps/app-protection-policy.md)
* [アプリの保護ポリシー (PIN、暗号化、名前を付けて保存、クリップボードなど)](../apps/app-protection-policies.md)
* [モバイル アプリから企業データを消去する](../apps/apps-selective-wipe.md)
...
ポータルのエクスペリエンスをカスタマイズするクイック ガイドについては、「[Azure Portal で Intune を始める](tutorial-walkthrough-intune-portal.md)」を参照してください。

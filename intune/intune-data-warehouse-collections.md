...
| 不明       | 何らかの理由でオフラインになっているか、Intune または Azure AD との通信に失敗したデバイスの数。                                                                           | 5        |
...
| 不明           | 何らかの理由でオフラインになっているか、Intune または Azure AD との通信に失敗したデバイスの数。                                                                           | 13       |
...
| ExtensionState    | IntuneManagementExtension の正常性状態。 | 正常 |
...
|:-----------------:|:--------------:|:---------------------------------------------------------------------------------------------------------------:|
| 0                 | 管理されている        | 保留なしのリモート アクションにより管理。                                                                       |

...
titlesuffix: ''
description: Microsoft Intune での Office 365 アプリのデータ管理と保護について説明します。
keywords: ''
author: Erikre
ms.author: erikre
manager: dougeby
...
1. OneDrive for Business アプリを起動し、サインイン ページを開きます。  
...
![PIN を設定および確認するプロンプトの画像](./media/pin-prompt-android.png)

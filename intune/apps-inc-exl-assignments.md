...
>
> Android Enterprise (旧称 Android for Work) は、含めるグループと除外するグループをサポートしています。 組み込みの**すべてのユーザー** グループと**すべてのデバイス** グループを Android Enterprise のアプリ割り当てに利用することができます。 
...
4. **[モバイル アプリ]** ウィンドウで、**[アプリ]** を選びます。 追加したアプリの一覧が表示されます。

...
-   最初のプロジェクト スコープにサポート準備やエンド ユーザー エクスペリエンスが含まれていないため、 エンド ユーザーに採用されにくいといった問題やサポート組織の課題が生じています。
...
-   組織の理解を得られるような明確な価値を提案したり、その価値を立証したり、積極的に伝えたりする努力を怠ると、 多くの場合、導入が制限され、十分な投資収益率 (ROI) が得られません。

...
5. **[設定]** で、次の情報を入力します。
   ...
   - **品質更新プログラムの遅延期間 (日数)**: 品質更新プログラムを遅延させる日数を指定します。 これらの品質更新プログラムの受信を、リリースから最大 30 日間延期できます。
     ...
     品質更新プログラムは、通常、既存の Windows 機能の修正プログラムや機能強化であり、月の最初の火曜日に公開されます。 ただし、Microsoft は、品質更新プログラムを任意のタイミングでリリースする可能性があります。 Windows Update 上で品質更新プログラムが入手できるようになってから、その受信を延期するかどうか、どれくらい延期するかを定義できます。

...
- **一時停止しています**: 更新プログラムのロールアウトで問題がある場合、更新プログラムのインストールを延期できます。 
...
Intune で、カスタム ポリシーの OMA-URI 設定を使用して商用 ID を構成できます。 詳しくは、「[Microsoft Intune での Windows 10 デバイス向けの Intune ポリシー設定](https://docs.microsoft.com/intune-classic/deploy-use/windows-10-policy-settings-in-microsoft-intune)」を参照してください。   

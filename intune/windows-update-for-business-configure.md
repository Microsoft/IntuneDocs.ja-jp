...
6. **[更新プログラムのリングの作成]** ウィンドウで、更新プログラム リングの名前と説明 (省略可能) を指定して、**[設定 - 構成]** を選択します。
7. **[設定]** ウィンドウで、以下の情報を構成します。
    - **サービス チャネル**: デバイスが Windows 更新プログラムを受信するチャネル (半期チャネル (対象指定) または半期チャネル) を設定します。
    - **Microsoft 製品の更新プログラム**: Microsoft Update のアプリの更新プログラムをスキャンするかどうかを選択します。
...
1. 完了したら、**[OK]** をクリックして、**[更新プログラムのリングの作成]** ウィンドウで **[作成]** をクリックします。
...
5. 次のレポートのいずれかを開きます。 
   ...
   **すべての展開リングの場合:**
   1. **[ソフトウェア更新プログラム]** > **[Windows 10 更新プログラムのリング]** ウィンドウの順に移動します。 
   2. **[監視] セクション**で、**[更新プログラムごとのリングの展開の状態]** を選択します。
                   
   **特定の展開リングの場合:** 
   1. **[ソフトウェア更新プログラム]** > **[Windows 10 更新プログラムのリング]** ウィンドウで、確認する展開リングを選択します。

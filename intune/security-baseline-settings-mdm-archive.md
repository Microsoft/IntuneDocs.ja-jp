...
- 現在の MDM セキュリティベースラインで[使用可能な設定を表示します。](security-baseline-settings-mdm.md) 
...
*このベースラインは、 [Spring 2019 (19h1) の MDM セキュリティ基準に置き換えられています。](security-baseline-settings-mdm.md)*

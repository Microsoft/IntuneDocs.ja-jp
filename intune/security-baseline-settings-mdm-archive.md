---
title: アーカイブ - Windows 10 用の Intune MDM セキュリティ ベースラインの設定
titleSuffix: Microsoft Intune
description: Microsoft Intune で Windows 10 を管理するためのセキュリティ ベースラインの MDM の設定の過去のリリース バージョンのアーカイブ
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 06/27/2019
...
ms.locfileid: "67418960"
---
<!-- This article contains the exact baseline details for baseline versions that were previously published in security-baseline-settings-mdm.md.  -->

# <a name="archive-of-mdm-security-baseline-settings"></a>MDM セキュリティ ベースラインの設定のアーカイブ  

Intune の MDM セキュリティ ベースラインのアーカイブされたバージョンの詳細を表示します。  

新しい MDM セキュリティ ベースラインを離すと、以前の設定の一覧がセキュリティ ベースラインの設定に関する記事からこのアーカイブに移動します。 これらのバージョンは、使用するため引き続きサポートされますし、古い基準バージョンの既定の設定を理解するうえで支援するためにこのアーカイブが提供されます。

使用する構成基準のバージョンがサポートされている不要になった場合はこの記事から削除します。

- 使用できる設定を表示する[MDM の現在のセキュリティ ベースライン](security-baseline-settings-mdm.md) 
- について[セキュリティ ベースライン](security-baselines.md)、およびセキュリティ ベースライン プロファイルに基準バージョンをアップグレードする方法。

## <a name="preview-mdm-security-baseline-for-october-2018"></a>プレビュー: 2018 年 10 月の MDM セキュリティ ベースライン  

*この基準は置き換え[Spring 2019 (19 H 1) 用のセキュリティ ベースラインの MDM](security-baseline-settings-mdm.md)*
...
[現在のベースライン バージョンを表示](security-baseline-settings-mdm.md)  
[新しい基準バージョンを使用するプロファイルをアップグレードします。](security-baselines.md#change-the-baseline-instance-for-a-profile)
...
- **システム整合性の保護を必要と**する:  
  ...
  - **必須**-macOS デバイスで[システム整合性保護](https://support.apple.com/HT204899)(Apple の web サイトを開く) が有効になっている必要があります。  
...
- **[単純なパスワード]** :  
  - **未構成**(*既定*)-ユーザーは、 **1234**や**1111**のようなパスワードを簡単に作成できます。
...
- **ステルス モード**:  
  - **未構成**(*既定*)-この設定は、ステルスモードをオフのままにします。
...
- **未構成**(*既定*)-gatekeeper オプションは、コンプライアンスまたは非対応に影響しません。  

...
| Setting | 使用する方法 | 既定値 |
|------|------|------|
| **iTunes と iCloud でのバックアップを禁止する** | すべての管理対象ファイルの iTunes および iCloud へのバックアップを無効にするには、**[はい]** を選びます。 このアプリが管理対象ファイルを iTunes および iCloud にバックアップできるようにするには、**[いいえ]** を選びます。| はい |

                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure Portal での Intune</h3>
                                            <p>Microsoft Intune は、Azure Portal で使用できます。 新しいポータルでのデバイスやアプリの管理についてご確認ください。 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>教育用の Intune とは</h3>
                                            <p>クラスルームのデバイスで行う必要がある、日常的な操作について説明します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune の概要</h3>
                                            <p>基本事項の説明: グループとユーザーを作成します。 デバイスを登録します。 ポリシーとアプリを割り当てます。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>ライセンス数が 150 以上ある場合に FastTrack 特典を利用する</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure での Intune の機能の移動先</h3>
                                            <p>クラシック コンソールでの Intune に慣れている場合は、Azure 上の Intune の機能について説明しているこの記事をお勧めします。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">すべての Intune ドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">すべての入門ドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">すべての展開の計画に関するドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/device-enrollment">すべての使用方法に関するドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">すべてのトラブルシューティングのドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Microsoft Intune App SDK の概要</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>iOS 用 Intune App SDK 開発者ガイド</h3>
                                            <p>iOS 用 Intune App SDK には、スタティック ライブラリ、リソース ファイル、API ヘッダー、デバッグ設定リストおよび構成ツールが含まれています。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Android 用 Intune App SDK 開発者ガイド</h3>
                                            <p>Android 用 Intune App SDK は、外部依存関係のない標準の Android ライブラリです。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intune アプリ ラッピング ツールまたは Intune App SDK のいずれかを使うと、アプリでモバイル アプリケーション管理 (MAM) ポリシーを使用することが可能です。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>すべてのドキュメントを探しですか。 <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">すべての Intune ドキュメント</a>を参照してください。</h3>
                            </div>
                        </li>
                    </ul>
                </li>

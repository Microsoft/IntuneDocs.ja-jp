...
ms.locfileid: "56891608"
---
# <a name="what-is-microsoft-intune"></a>Microsoft Intune とは

[!INCLUDE [both-portals](./includes/note-for-both-portals.md)]

Intune はエンタープライズ モビリティ管理 (EMM) スペースのクラウドベース サービスであり、会社のデータを守りながら、社員に生産的に働いてもらうことができます。 他の Azure サービスと同様に、Microsoft Intune は Azure Portal で使用できます。 Intune では次のことができます。

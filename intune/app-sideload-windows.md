...
最初のステップは、appx パッケージにコード署名することです。「[SignTool を使ってアプリ パッケージに署名する](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool)」をご覧ください

## <a name="upload-your-app"></a>アプリをアップロードする

次に、[LOB Windows アプリのアップロード](lob-apps-windows.md)に関するページで説明されているように、署名された appx ファイルをアップロードします
...
Windows Phone 8.1 モバイル アプリの展開に使用された証明書は、2019 年 2 月 28 日に廃止され、Symantec から更新されなくなりました。 WIndows 10 Mobile に展開する場合は、Windows 10 の指示に従って、引き続き Symantec Desktop Enterprise コード署名証明書を使用できます。

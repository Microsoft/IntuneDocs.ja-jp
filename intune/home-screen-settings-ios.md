...
これらの設定を使用すると、iOS の Dock とホーム画面で、アプリ、フォルダー、Web クリップのレイアウトを構成できます。
...
2. **[行の追加]** ブレードで、**ページ名**を入力します。 この名前は Intune ポータルでの参照用に使われ、iOS デバイスでは "*表示されません*"。
...
1. **[アプリ名]** を入力します。 この名前は Intune ポータルでの参照用に使われ、iOS デバイスでは "*表示されません*"。
...
3. **[行の追加]** ブレードで、ページの名前を入力します。 この名前は Intune ポータルでの参照用に使われ、iOS デバイスでは "*表示されません*"。
3. **[アプリ名]** を入力します。 この名前は Intune ポータルでの参照用に使われ、iOS デバイスでは "*表示されません*"。

...
> [!IMPORTANT]
> Intune では、デバイス上のすべてのコンプライアンス評価をデバイスのチェックイン スケジュールに従って行います。 [デバイスのチェックイン スケジュールの詳細については、こちらをご覧ください](device-profile-troubleshoot.md#how-long-does-it-take-for-devices-to-get-a-policy-profile-or-app-after-they-are-assigned)。
...
>
> これは、マルチユーザーの Windows 10 デバイスに関する既知の問題です。 この動作に対するすべての変更または更新は、[開発中](in-development.md)や[新機能](whats-new.md)に関するページで発表されます。

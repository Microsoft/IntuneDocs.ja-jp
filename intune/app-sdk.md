...
title: Intune App SDK のメリット titlesuffix: Microsoft Intune の説明: Intune アプリ SDK は、iOS プラットフォームと Android プラットフォームの両方で利用でき、Microsoft Intune を使ったモバイル アプリ管理機能を有効にします。

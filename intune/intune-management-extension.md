...
- デバイスを Azure AD に参加させ、[自動登録](windows-enroll.md#enable-windows-10-automatic-enrollment)する必要があります。 Intune 管理拡張機能では、Azure AD 参加済み、ハイブリッド ドメイン参加済み、および共同管理登録済みの Windows デバイスがサポートされます。 GPO に登録されたデバイスはサポートされていません。

...
|要件|詳細情報|
|---------------|--------------------|
|オペレーティング システム | Windows 7 SP1 以降を実行している Windows デバイスであること。 </br></br>**Home エディションのバージョンはサポートされていません。**|
...
Microsoft Intune の詳細については、[デバイスの登録](device-enrollment.md)を参照してください。

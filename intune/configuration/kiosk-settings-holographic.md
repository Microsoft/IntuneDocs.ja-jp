...
- **[アプリケーション]** : キオスク デバイスで実行するアプリを追加します。 複数のアプリを追加することができます。
  ...
  - **ストアアプリの追加**: LOB アプリを含む[クライアントアプリ](../apps/apps-add.md)として Intune に追加または展開した既存のアプリを選択します。 アプリが一覧表示されていない場合、intune は[intune に追加](../apps/store-apps-windows.md)する多くの[アプリの種類](../apps/apps-add.md)をサポートします。

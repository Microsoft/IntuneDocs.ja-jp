...
5. **[<*ロール名*> - 概要]** ウィンドウで、**[管理]**、**[割り当て]** の順に選択します。

6. [カスタム ロール] ウィンドウで、**[割り当て]** を選択します。

7. **[ロールの割り当て]** ウィンドウで、割り当ての **[名前]** と省略可能な **[説明]** を入力します。

8. **[メンバー]** については、アクセス許可を付与するユーザーを含むグループを選択します。

9. **[スコープ]** については、上記のメンバーが管理できるユーザーを含むグループを選択します。
<br></br>
10. 終了したら、**[OK]** を選択します。 新しい割り当てが割り当ての一覧に表示されます。
...
2. **[<*ロール名*> - 概要]** ウィンドウで、**[管理]**、**[割り当て]** の順に選択します。 このウィンドウで、既存のロールを編集または削除することもできます。

3. [カスタム ロール] ウィンドウで、**[割り当て]** を選択します。

4. **[ロールの割り当て]** ウィンドウで、割り当ての **[名前]** と省略可能な **[説明]** を入力します。

5. **[メンバー]** については、アクセス許可を付与するユーザーを含むグループを選択します。

6. **[スコープ]** については、上記のメンバーが管理できるユーザーを含むグループを選択します。

7. 終了したら、**[OK]** を選択します。 新しい割り当てが割り当ての一覧に表示されます。

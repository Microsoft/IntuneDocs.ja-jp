...
| **承認済みキーボード**  | *[必要]* を選択してから、このポリシーに対して承認されているキーボードの一覧を指定します。 <p>承認済みキーボードを使用していないユーザーは、保護されたアプリを使用するには、承認済みキーボードをダウンロードしてインストールするように求められます。  | **必要なし** |

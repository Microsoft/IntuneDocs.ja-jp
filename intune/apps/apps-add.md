...
>[!TIP]
> LOB アプリとは、アプリのインストール ファイルから追加するアプリのことです。 たとえば、iOS LOB アプリをインストールするには、 **[アプリの種類の選択]** ペインで **[アプリの種類]** として **[基幹業務アプリ]** を選択してアプリを追加します。 次に、アプリ パッケージ ファイル (拡張子 .ipa) を選択します。 この種のアプリは、通常、社内で作成されます。
...
- **社内で作成された (基幹業務) アプリ**: 社内で作成されたアプリが基幹業務 (LOB) アプリです。 この種類のアプリの機能は、Windows、iOS、macOS、Android など、Intune でサポートされているプラットフォームのいずれか 1 つに向けて作成されています。 組織は更新プログラムを作成し、管理者に個別のファイルとして提供します。 管理者は、アプリの更新プログラムをユーザーに提供するために、Intune を使用して更新プログラムを追加および展開します。

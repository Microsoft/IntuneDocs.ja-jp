...
5. **[VPP トークンの作成]** ウィンドウで、次の情報を指定します。
    ...
    - **アプリの自動更新** - **[オン]** で **[オフ]** を選択し、自動更新を有効/無効にします。 有効にすると、アプリ ストア内の VPP アプリ更新プログラムが Intune によって検出され、デバイスのチェックイン時に自動的にデバイスにプッシュされます。 Apple VPP アプリの自動アプリ更新により、**必須**インストール インテントでデプロイされたアプリのみが自動的に更新されます。 **利用可能**インストール インテントでデプロイされたアプリの場合は、以前のバージョンのアプリがインストールされている場合でも、ユーザーに対して、ポータル サイトにアプリが未インストールとして表示されます。 この場合、ユーザーは、ポータル サイト アプリのアプリの詳細画面で **[インストール]** をクリックして新しいバージョンのアプリをインストールすることで、アプリを再インストールできます。 ユーザーが登録した iOS デバイスの場合、エンド ユーザーには、Intune ポータル サイト内のすべてのユーザー ライセンス VPP アプリが引き続き表示されることに注意してください。 

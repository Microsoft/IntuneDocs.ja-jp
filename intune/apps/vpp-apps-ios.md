...
6. 完了したら、 **[作成]** を選択します。 トークンがトークンの一覧ウィンドウに表示されます。
...
アプリ関連の問題のトラブルシューティングについては、[アプリのトラブルシューティング方法](~/apps/troubleshoot-app-install.md)に関する記事をご覧ください。

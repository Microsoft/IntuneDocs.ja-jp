...
5. **[VPP トークンの作成]** ウィンドウで、次の情報を指定します。
    ...
    - **[国/地域]** - VPP 国/地域別ストアを選びます。  指定された VPP 国/リージョン別ストアにある全ロケールに対応した VPP アプリが、Intune によって同期されます。
        > [!WARNING]  
        > 国/地域を変更すると、このトークンで作成されたアプリが Apple サービスと次に同期するときに、アプリのメタデータとストアの URL が更新されます。 新しい国/地域別ストアに存在しないアプリは更新されません。

    - **[VPP アカウントの種類]** - **[ビジネス]** または **[教育]** を選択します。
    - **アプリの自動更新** - **[オン]** で **[オフ]** を選択し、自動更新を有効/無効にします。 有効にすると、アプリ ストア内の VPP アプリ更新プログラムが Intune によって検出され、デバイスのチェックイン時に自動的にデバイスにプッシュされます。 Apple VPP アプリの自動アプリ更新により、**必須**インストール インテントでデプロイされたアプリのみが自動的に更新されます。 **利用可能**インストール インテントでデプロイされたアプリでは、自動更新により、新しいバージョンのアプリが利用できることを管理者に知らせる通知が生成されます。 さらに、以前のバージョンのアプリがインストールされている場合でも、ユーザーに対して、ポータル サイトにアプリが未インストールとして表示されます。 この場合、ユーザーは、ポータル サイト アプリのアプリの詳細画面で **[インストール]** をクリックして新しいバージョンのアプリをインストールすることで、アプリを再インストールできます。
...
| 4 | BYOD – デバイス ライセンスあり                           | N                                                                                               | ○                                           | N                                 |
| 5 | CORP – デバイス ライセンスあり (非監視対象デバイス)                           | N                                                                                               | ○                                           | N                                 |

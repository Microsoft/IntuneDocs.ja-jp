...
一般的な解決策が役に立たない場合は、**[サポート要求]** を選択して新しいサポート要求を作成することができます。これにより Azure の "*ヘルプとサポート*" ページの **[基本]** タブが開きます。 続行してサポート チケットを作成するには、手順「[オンライン サポート チケットを作成](#create-an-online-support-ticket)」の "*ステップ 3*" に進んでください。

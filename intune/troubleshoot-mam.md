...
**アカウントがセットアップされていません**:お客様の組織が、職場または学校のデータにアクセスするためのアカウントを設定していません。 IT 管理者にお問い合わせください。 | ユーザー アカウントに Intune A Direct ライセンスがありません。 | [Office ポータル](http://portal.office.com)でユーザーのアカウントに Intune ライセンスが割り当てられていることを確認します。

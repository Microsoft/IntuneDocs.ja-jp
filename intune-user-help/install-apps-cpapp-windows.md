...
アプリは組織によって割り当てられ、ポータルサイト のラベルが **利用可能** または **必須** として表示されます。 
...
* [名前]: アプリの名前。 利用可能なアプリには、 **[アプリの詳細]** ページへのリンクがあります。
...
このページを表示するには、ナビゲーションメニューに移動し、 **[インストール済みアプリ]** を選択します。 
  ...
  ![Windows 10 用ポータル サイト アプリの [インストール済みアプリ] ページのサンプル スクリーンショット。 ](./media/installed-apps-cp-1906.png)  

...
この場合、デバイスは会社リソースにアクセスできなくなり、ほとんどの場合はデバイスを工場出荷時設定にリセットすることが必要になります。 会社のサポートに問い合わせることをお勧めします。 連絡先情報については、[ポータル サイト Web サイト](https://portal.manage.microsoft.com#HelpDeskDialog)をご確認ください。

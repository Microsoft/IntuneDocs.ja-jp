...
この問題が発生した場合、ポータル サイト チームでは根本原因を探し、診断するために、ポータル サイトのログが必要になります。 Microsoft にログを送信するには、次の手順に従います。
...
3.  **[フィードバック]** で [**フィードバックの送信]** をタップします。

4.  発生している問題の概要をメールに入力し、**[送信]** をタップします。

Android のポータル サイト チーム (<a href="mailto:wintunedroidfbk@microsoft.com?subject=Send logs to Microsoft&body=Describe the issue you are having.">wintunedroidfbk@microsoft.com</a>) に直接メールを送ることもできます。 

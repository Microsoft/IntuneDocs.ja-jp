...
- [Exchange Active Sync On-Premises Exchange Connector](install-intune-on-premises-exchange-connector.md) を使用する必要があります。これは、Intune を Exchange On-Premises に接続します。

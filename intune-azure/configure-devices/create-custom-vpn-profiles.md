---
title: "Microsoft Intune でカスタム VPN プロファイルを作成する方法 | Microsoft Docs"
...
# <a name="how-to-create-custom-vpn-profiles-with-microsoft-intune"></a>Microsoft Intune でカスタム VPN プロファイルを作成する方法

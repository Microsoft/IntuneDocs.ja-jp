---
title: "macOS デバイス向けの Intune Wi-Fi 設定 | Intune Azure プレビュー | Microsoft Docs"
description: "Intune Azure プレビュー: macOS デバイスで Wi-Fi 接続を構成するために使用できる Intune 設定について説明します。"
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="intune-wi-fi-settings-for-macos-devices-in-intune-azure-preview"></a>Intune Azure プレビューでの macOS デバイス向けの Intune Wi-Fi 設定

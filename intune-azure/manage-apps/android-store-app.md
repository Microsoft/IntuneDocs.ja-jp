---
title: "Android ストア アプリを Intune に追加する方法 | Intune Azure プレビュー | Microsoft Docs"
description: "Intune Azure プレビュー: Android ストア アプリを Intune に追加する方法について説明します。"
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-android-store-apps-to-intune"></a>Android ストア アプリを Intune に追加する方法

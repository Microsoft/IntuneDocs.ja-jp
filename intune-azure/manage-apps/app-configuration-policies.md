---
title: "Intune アプリ構成ポリシーを使用する方法 | Microsoft Docs"
...
> -   **iOS 用アプリ パッケージ**
>
> アプリのインストールの種類の詳細については、「[How to add an app to Microsoft Intune (Microsoft Intune にアプリを追加する方法)](add-apps.md)」を参照してください。

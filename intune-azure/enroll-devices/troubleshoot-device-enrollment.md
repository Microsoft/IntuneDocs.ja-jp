---
title: "デバイス登録に関するトラブルシューティング | Intune Azure プレビュー | Microsoft Docs"
...
[こちら](https://docs.microsoft.com/intune/enduser/you-see-errors-while-trying-to-enroll-your-device-in-intune-ios)から、エンド ユーザーに表示される可能性のある iOS 登録エラーの一覧をご覧いただけます。 この一覧には、エンド ユーザーに表示される可能性のあるエラー メッセージと、問題を解決するために実行すべき手順についての情報がまとめられています。

---
title: "Android 用のコンプライアンス ポリシーを作成する方法 | Intune Azure プレビュー | Microsoft Docs"
...
# <a name="how-to-create-a-device-compliance-policy-for-android-devices-in-intune-azure-preview"></a>Intune Azure プレビューで Android デバイス用のデバイス コンプライアンス ポリシーを作成する方法

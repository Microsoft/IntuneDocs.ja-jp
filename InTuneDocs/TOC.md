...
# 計画と設計
## [展開計画、設計および実装](plan-design/introduction.md)
...
## [移行](plan-design/intune-mdm-migration-guide.md)
### [フェーズ 1: MDM の Intune を準備する](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [基本的なセットアップ](plan-design/migration-phase1-basic-setup.md)
#### [デバイスおよびアプリ管理のポリシー](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [アプリ保護ポリシーの構成](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [特殊な移行に関する考慮事項](plan-design/migration-phase1-special-migration-considerations.md)
### [フェーズ 2: 移行のキャンペーン](plan-design/migration-phase2-migration-campaign.md)
#### [情報伝達計画](plan-design/migration-phase2-communication-plan.md)
#### [採用を推進](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [標準的な移行サイクル](plan-design/migration-phase2-typical-migration-cycle.md)
...
### [MAM が有効なアプリのある Android のエンドユーザー エクスペリエンス](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [MAM が有効なアプリのある iOS のエンドユーザー エクスペリエンス](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)

...
アプリは、ユーザー操作なしでインストールできます。また、ユーザーが**不明なソースからのインストール**を許可する必要もありません。 オプションまたは使用可能なアプリを参照およびインストールする場合、デバイスで Google Play ストアを参照できます。 詳細については、「[Intune を使用してアプリを Android for Work デバイスを展開する方法](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)」を参照してください。
...
[Android for Work の登録を有効にする](https://docs.microsoft.com/intune/deploy-use/set-up-android-for-work)

[Android for Work 用アプリの展開](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)

...
-   [Intune で MAM プロバイダーを構成する方法](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10)を理解します。
...
組織で Intune を設定した後は、[Azure Portal](https://docs.microsoft.com/intune/deploy-use/azure-portal-for-microsoft-intune-mam-policies) を使用して WIP 固有のポリシーを作成できます。
...
2.  **[アプリに関するポリシー]** ブレードで **[ポリシーの追加]** を選び、次の値を入力します。
    ...
    c.  **[プラットフォーム]:** アプリ保護ポリシーのサポート対象プラットフォームとして **[Windows 10]** を選びます。

    d.  **[登録の状態]:** ポリシーの登録状態として、**[未登録]** を選びます。
...
2.  **[許可されているアプリ]** ブレードで、**[アプリの追加]** を選びます。 **[アプリの追加]** ブレードが開き、この一覧に含まれるすべてのアプリが表示されます。

3.  企業データへのアクセスを許可する各アプリを選び、**[OK]** を選びます。 **[許可されているアプリ]** ブレードが更新され、選んだすべてのアプリが表示されます。
...
2.  **[許可されているアプリ]** ブレードで、**[アプリの追加]** を選びます。

3.  **[アプリの追加]** ブレードで、ドロップダウン リストから **[ストア アプリ]** を選びます。 ブレードが変化し、**パブリッシャー**とアプリの**名前**を追加するためのボックスが表示されます。

4.  アプリの名前とパブリッシャーの名前を入力し、**[OK]** を選びます。
...
5.  フィールドに情報を入力した後、**[OK]** を選んで **[許可されているアプリ]** の一覧にアプリを追加します。

> [!NOTE]
> 同時に複数のストア アプリを追加するには、アプリ行の末尾にあるメニュー **[...]** をクリックし、アプリの追加を続けます。 終了したら、**[OK]** を選びます。
...
3.  **[アプリの追加]** ブレードで、ドロップダウン リストから **[デスクトップ アプリ]** を選びます。

4.  フィールドに情報を入力した後、**[OK]** を選んで **[許可されているアプリ]** の一覧にアプリを追加します。

> [!NOTE]
> 同時に複数の**デスクトップ アプリ**を追加するには、アプリ行の末尾にあるメニュー **[...]** をクリックし、アプリの追加を続けます。 終了したら、**[OK]** を選びます。

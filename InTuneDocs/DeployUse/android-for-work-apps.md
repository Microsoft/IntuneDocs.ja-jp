...
# Intune を使用してアプリを Android for Work デバイスを展開する方法
...
## Google Play for Work ストアのアプリを同期する
...
## Google Play for Work ストアから基幹業務アプリを公開し、同期する 

1. Google Play Developer Console で、[play.google.com/apps/publish](play.google.com/apps/publish) を開きます。

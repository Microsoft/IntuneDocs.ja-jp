...
title: SDK を使用してモバイル アプリケーション管理に対応する | Microsoft Intune
description:
keywords:
author: Staciebarker
manager: jeffgilb
...
SDK の概要については、[概要](https://msdn.microsoft.com/en-us/library/mt627767.aspx)ページをご覧ください。 Intune App SDK の基本的な使い方については、「[Getting Started With the Microsoft Intune App SDK (Microsoft Intune アプリ SDK を使ってみる)](https://msdn.microsoft.com/library/mt627766.aspx)」をご覧ください。.

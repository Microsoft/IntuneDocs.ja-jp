...
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**モバイル デバイスのロックを解除するパスワードを要求する**|いいえ|[いいえ]|○|○|○|
|**必要なパスワードの種類**<br /><br />この設定は、数値のみや英数字など、必要なパスワードの種類を指定します。|Yes|○|○|○|いいえ|
|**必要なパスワードの種類 - 文字セットの最小数**<br /><br />文字セットには、小文字、大文字、数字、および記号の 4 種類があります。 この設定では、パスワードに含める必要がある文字セットの数を指定します。 ただし、iOS デバイスの場合は、パスワードに含める必要がある記号の数を指定します。|[はい]|○|○|○|いいえ|
|**最小のパスワードの長さ**|○|○|○|○|○|
|**単純なパスワードを許可する**<br /><br />単純なパスワードには、"0000" や "1234" があります|いいえ|[いいえ]|○|○|いいえ|
|**デバイスをワイプするまでの連続サインイン エラーの数**|○|○|○|○|○|
|**画面がオフになるまでの非アクティブな時間 (分)**<sup>1</sup>|○|○|○|○|○|
|**パスワードの有効期限 (日)**|○|○|○|○|○|
|**パスワードの履歴を記憶する**|○|○|○|○|○|
|**パスワードの履歴を保存する** - **前のパスワードを再利用できないようにする**|○|○|○|○|○|
|**パスワードの品質**|いいえ|いいえ|いいえ|[いいえ]|○|
|**ピクチャ パスワードと PIN を許可する**|○|○|[いいえ]|いいえ|いいえ|
|**パスワードが必要になるまでの非アクティブ状態の時間 (分)**|いいえ|いいえ|[いいえ]|○|いいえ|
...
|**Google アカウントの自動同期を許可する**|いいえ|いいえ|いいえ|いいえ|はい (Samsung KNOX のみ)|
...
|**Windows メール アプリケーションで Microsoft アカウントをオプションにする**|○|[いいえ]|いいえ|いいえ|いいえ|
...
|設定の名前|Windows 8.1 および Windows RT 8.1|Windows RT|Windows Phone 8 および Windows Phone 8.1|iOS|Android および Samsung KNOX|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Web ブラウザーを許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|○|はい (Samsung KNOX のみ)|
|**オートコンプリートを使用する**|○|[いいえ]|[いいえ]|○|はい (Samsung KNOX のみ)|
|**ポップアップ ブロックを使用する**|○|[いいえ]|[いいえ]|○|はい (Samsung KNOX のみ)|
|**Cookie を使用する**|いいえ|いいえ|[いいえ]|○|はい (Samsung KNOX のみ)|
|**プラグインを使用する**|○|[いいえ]|いいえ|いいえ|いいえ|
|**アクティブ スクリプティングを使用する**|○|[いいえ]|[いいえ]|○|はい (Samsung KNOX のみ)|
|**不正行為の警告を使用する**|○|[いいえ]|[いいえ]|○|[いいえ]|
|**1 単語の入力でイントラネット サイトにアクセスできるようにする**<br /><br />(この設定を使うと、"Bing" のような 1 つの単語を使用すると Internet Explorer が Web サイトにアクセスするようになります。)|Yes|[いいえ]|いいえ|いいえ|いいえ|
|**イントラネット ネットワークの自動検出を使用する**|○|[いいえ]|いいえ|いいえ|いいえ|
|**インターネットのセキュリティ レベル**|○|[いいえ]|いいえ|いいえ|いいえ|
|**イントラネットのセキュリティ レベル**|○|[いいえ]|いいえ|いいえ|いいえ|
|**信頼済みサイトのセキュリティ レベル**|○|[いいえ]|いいえ|いいえ|いいえ|
|**制限付きサイトのセキュリティ レベル**|○|[いいえ]|いいえ|いいえ|いいえ|
|**Do Not Track ヘッダーを送信する**|○|[いいえ]|いいえ|いいえ|いいえ|
|**エンタープライズ モード メニューへのアクセスを許可する**|○|[いいえ]|いいえ|いいえ|いいえ|
|**エンタープライズ モード サイト リストの場所**|○|[いいえ]|いいえ|いいえ|いいえ|

## アプリケーションの設定 - アプリケーション

|設定の名前|Windows 8.1 および Windows RT 8.1|Windows RT|Windows Phone 8 および Windows Phone 8.1|iOS|Android および Samsung KNOX|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**アプリケーション ストアを許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|○|はい (Samsung KNOX のみ)|
|**アプリケーション ストアへのアクセスにパスワードを必要とする**|いいえ|いいえ|[いいえ]|○|いいえ|
|**アプリ内購入を使用する**|いいえ|いいえ|[いいえ]|○|いいえ|
|**他の管理対象ではないアプリで管理対象ドキュメントを使用する**|いいえ|いいえ|いいえ|iOS 7 以降|いいえ|
|**他の管理対象アプリで管理対象ではないドキュメントを使用する**|いいえ|いいえ|いいえ|iOS 7 以降|いいえ|
|**ビデオ会議を使用する**|いいえ|いいえ|[いいえ]|○|いいえ|
|**メディア ストアでアダルト コンテンツを許可する**|いいえ|いいえ|[いいえ]|○|いいえ|
...
|設定の名前|Windows 8.1 および Windows RT 8.1|Windows RT|Windows Phone 8 および Windows Phone 8.1|iOS|Android および Samsung KNOX|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**ゲーム センターの友だちを使用する**|いいえ|いいえ|[いいえ]|○|いいえ|
|**マルチプレイヤー ゲームを使用する**|いいえ|いいえ|[いいえ]|○|いいえ|

## デバイス機能の設定 - ハードウェア

|設定の名前|Windows 8.1 および Windows RT 8.1|Windows RT|Windows Phone 8 および Windows Phone 8.1|iOS|Android および Samsung KNOX|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**カメラを許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|○|○|
|**リムーバブル記憶域を許可する**|いいえ|[いいえ]|○|いいえ|はい (Samsung KNOX のみ)|
|**Wi-Fi を許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|いいえ|はい (Samsung KNOX のみ)|
|**Wi-Fi テザリングを許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|いいえ|はい (Samsung KNOX のみ)|
...
|**位置情報を許可する**<br /><br />この設定は、デバイスで位置情報を使用できるようにします。|いいえ|いいえ|Windows Phone 8.1 のみ|いいえ|はい (Samsung KNOX のみ)|
|**NFC を許可する**<br /><br />この設定は、近距離無線通信を使用する操作を許可します。|いいえ|いいえ|Windows Phone 8.1 のみ|いいえ|はい (Samsung KNOX のみ)|
|**Bluetooth を許可する**|いいえ|いいえ|Windows Phone 8.1 のみ|いいえ|はい (Samsung KNOX のみ)|
|**電源の切断を許可する**<br>この設定が無効の場合、Samsung KNOX デバイスの **[デバイスをワイプするまでの連続サインイン エラーの回数]** 設定は機能しません。|いいえ|いいえ|いいえ|いいえ|はい (Samsung KNOX のみ)|

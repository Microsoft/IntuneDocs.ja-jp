---
title: "Intune から iOS デバイスの登録を解除するとどうなりますか。 | Microsoft Docs"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
# <a name="what-happens-if-you-unenroll-your-ios-device-from-intune"></a>Intune から iOS デバイスの登録を解除するとどうなりますか。

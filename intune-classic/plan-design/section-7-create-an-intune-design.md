...
-   **クラウド内の ID**
    ...
    -   DirSync または Azure Active Directory (AAD) Connect を使っているか
...
-   詳しくは、「[Intune 対応デバイス](/intune-classic/get-started/supported-mobile-devices-and-computers)」をご覧ください。
...
-   詳細については、「[デバイスを構成すると、会社の Wi-Fi ネットワークに接続できます]/intune-classic/deploy-use/wi-fi-connections-in-microsoft-intune)」を参照してください。
...
-   企業向け iOS ボリューム購入プログラム (VPP) についてはこちらをご覧ください。

...
-   条件付きアクセスの詳細については、[ここ](https://docs.microsoft.com/intune/conditional-access)をご覧ください。
...
-   条件付きアクセスを構成する方法については、[こちら](/intune-classic/deploy-use/restrict-access-to-email-and-o365-services-with-microsoft-intune)を参照してください。

### <a name="task-2-set-up-intune-conditional-access"></a>タスク 2: Intune の条件付きアクセスのセットアップ

詳細については、次の条件付きアクセス ポリシーの種類のいずれかを選択します。

-   [Exchange Online と新しい Exchange Online Dedicated](/intune-classic/deploy-use/restrict-access-to-exchange-online-with-microsoft-intune)

-   [Exchange On-Premises と以前の Exchange Online Dedicated](/intune-classic/deploy-use/restrict-access-to-exchange-onpremises-with-microsoft-intune)
...
-   [電子メール アクセスのシナリオの例](/intune-classic/deploy-use/restrict-email-access-example-scenarios)

## <a name="next-steps"></a>次のステップ

[フェーズ 2: 標準的な移行サイクル](/intune-classic/plan-design/migration-phase2-typical-migration-cycle)

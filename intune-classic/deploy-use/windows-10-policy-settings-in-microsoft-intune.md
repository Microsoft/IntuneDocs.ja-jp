...
各 OMA-URI 設定を追加するには、次の情報を入力します。 このトピックにある [Windows 10 URI 設定のリファレンス](/intune-classic/deploy-use/windows-10-policy-settings-in-microsoft-intune#Windows-10-URI-settings)で、使用できる設定の詳細について説明します。

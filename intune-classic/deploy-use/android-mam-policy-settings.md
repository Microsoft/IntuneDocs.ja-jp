...
> [!IMPORTANT]
Intune アプリの保護ポリシーは Azure Portal に完全に移行されているため、このページのコンテンツの大部分は古くなっています。 Azure Portal での Android 向けの Intune アプリ保護ポリシーについては、[こちら](https://docs.microsoft.com/intune/app-protection-policy-settings-android)で確認してください。

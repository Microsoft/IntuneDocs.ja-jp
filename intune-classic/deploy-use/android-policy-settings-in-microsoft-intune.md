...
|----------------|-|----------------|----------------|
|**モバイル デバイスのロックを解除するパスワードを要求する**|サポート対象のデバイスでパスワードを要求するかどうかを指定します。|○|[はい]|
|**最小のパスワードの長さ**|パスワードの最小文字数を指定します。|○|Yes|
|**デバイスをワイプするまでの連続サインイン エラーの数**|デバイスをワイプするまでのサインイン エラーの数を指定します。|○|Yes|
|**画面がオフになるまでの非アクティブな時間 (分)**|デバイスが自動的にロックされるまでの非アクティブな分数を指定します。|○|Yes|
|**パスワードの有効期限 (日)**|パスワードの変更が必要になるまでの日数を指定します。|○|Yes|
|**パスワードの履歴を記憶する**|記憶される以前に使用されていたパスワードの数を指定します。|○|○|
|**パスワードの履歴を保存する** - **前のパスワードを再利用できないようにする**|以前のパスワードを再利用できないようにします。|○|Yes|
|**パスワードの品質**|必要なレベルのパスワードの複雑さと、生体認証デバイスを使用できるかどうかを選択します。|○|[はい]|
...
|設定の名前|説明|Android 4.0 以降|Samsung KNOX Standard|
|----------------|---|-------------|----------------|
|**モバイル デバイスの暗号化を要求する**|モバイル デバイス上のファイルを必ず暗号化するようにします。|○|[はい]|
|**メモリ カードの暗号化を必要とする**|デバイスのメモリ カードを暗号化する必要があるかどうかを指定します。|いいえ|○|

### <a name="system-settings"></a>システムの設定

|設定の名前|説明|Android 4.0 以降|Samsung KNOX Standard|
|----------------|---|-------------|----------------|
|**画面のキャプチャを許可する**|ユーザーが画面のコンテンツを画像としてキャプチャできるようにします。|いいえ|Yes|
|**診断データの送信を使用する**|デバイスが Google に診断情報を送信するのを許可します。|いいえ|Yes|
|**工場出荷時のリセットを許可する**|ユーザーがデバイスを出荷時の設定に戻せるようにします。|いいえ|○|

### <a name="cloud-settings---documents-and-data"></a>クラウドの設定 – ドキュメントおよびデータ

|設定の名前|説明|Android 4.0 以降|Samsung KNOX Standard|
|----------------|----|------------------------|----------------|
|**Google へのバックアップの許可**|Google へのバックアップを使用できるようにします。|いいえ|○|

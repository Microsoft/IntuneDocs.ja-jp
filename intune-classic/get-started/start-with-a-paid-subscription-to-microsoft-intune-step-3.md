...
- **ヘルプデスク - グループ ノード**: この権限を持つサービス管理者は、ヘルプデスクのシナリオに関するタスクだけを実行できます。「[管理者の役割に応じて Intune コンソール ビューをカスタマイズする](/intune-classic/deploy-use/control-what-admins-can-see-in-the-microsoft-intune-admin-console)」をご覧ください
